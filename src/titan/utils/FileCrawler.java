...
public class FileCrawler {
    ...
    private Image JAVA_FILE = new Image(getClass().getResourceAsStream("/titan/res/icons/lang/java_icon.png"));
    private Image HTML_FILE = new Image(getClass().getResourceAsStream("/titan/res/icons/lang/html_icon.png"));
    private Image CSS_FILE = new Image(getClass().getResourceAsStream("/titan/res/icons/lang/css_icon.png"));
    private Image JS_FILE = new Image(getClass().getResourceAsStream("/titan/res/icons/lang/js_icon.png"));

    //Folder Icons
    private Image NORMAL_DIR = new Image(getClass().getResourceAsStream("/titan/res/icons/folder/folder_icon.png"));
    private Image DOCS_DIR = new Image(getClass().getResourceAsStream("/titan/res/icons/folder/docs_folder.png"));
    private Image AUDIO_DIR = new Image(getClass().getResourceAsStream("/titan/res/icons/folder/audio_folder.png"));
    private Image IMAGES_DIR = new Image(getClass().getResourceAsStream("/titan/res/icons/folder/images_folder.png"));
    private Image VIDEOS_DIR = new Image(getClass().getResourceAsStream("/titan/res/icons/folder/videos_folder.png"));
    private Image GIT_DIR = new Image(getClass().getResourceAsStream("/titan/res/icons/folder/git_folder.png"));

    //Normal Files Icons
    private Image TEXT_FILE = new Image(getClass().getResourceAsStream("/titan/res/icons/file/text_file.png"));
    private Image ZIP_FILE = new Image(getClass().getResourceAsStream("/titan/res/icons/file/zip_file.png"));
    private Image PDF_FILE = new Image(getClass().getResourceAsStream("/titan/res/icons/file/pdf_file.png"));
    ...
    /**
     * @param source : recuperation des fichiers sources
     * @return : retourne l'arbre des fichiers sources avec leurs icons
     */
